...
model_path = '../data/model/lpd_{0:03}.hdf5'.format(filenum-4)
...
for tta in range(50):
    ...
    '''
    ##### 예측률 먼저 찍어보자
    percent_save = pd.DataFrame(temp_percent, index = None)
    percent_save.to_csv(save_folder + '/sample_{0:03}_{1:02}_percent.csv'.format(filenum, (tta+1)), index = False)
