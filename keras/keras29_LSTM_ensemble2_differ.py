...
x2_pred = x2_pred.reshape(x2_pred.shape[0],x2_pred.shape[1])


''' # x1 Dense
x1 = x1.reshape(x1.shape[0],x1.shape[1])
x2 = x2.reshape(x2.shape[0],x2.shape[1],1)
x1_pred = x1_pred.reshape(x1_pred.shape[0],x1_pred.shape[1])
...
d2 = Dense(12, activation = 'relu')(input2)
d2 = Dense(11)(d2)
d2 = Dense(11)(d2)
d2 = Dense(11)(d2)
d2 = Dense(7)(d2)
...
# x2 Dense
# loss :  [0.11534837633371353, 0.2011064887046814]
# [[86.408516]]
# loss :  [0.2576337158679962, 0.2780969440937042]
# [[84.46319]]
# loss :  [0.6579205393791199, 0.7032588720321655]
# [[85.02411]]

# x1 Dense
# loss :  [0.5041898488998413, 0.5352259874343872]
# [[87.86349]]
# loss :  [1.0409945249557495, 0.6446068286895752]
# [[86.67048]]
# loss :  [1.8265492916107178, 0.6660680174827576]
# [[85.14025]]