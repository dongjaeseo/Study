...
np.save('../data/npy/cancer_x.npy', arr = breast_cancer_x)
np.save('../data/npy/cancer_y.npy', arr = breast_cancer_y)
...
np.save('../data/npy/cifar100_x_train.npy', arr = c10_x_train)
np.save('../data/npy/cifar100_x_test.npy', arr = c10_x_test)
np.save('../data/npy/cifar100_y_train.npy', arr = c10_y_train)
np.save('../data/npy/cifar100_y_test.npy', arr = c10_y_test)