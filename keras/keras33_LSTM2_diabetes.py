...
x_train = x_train.reshape(x_train.shape[0],x_train.shape[1],1)   # ( ,10,1)
x_test = x_test.reshape(x_test.shape[0],x_test.shape[1],1)       # ( ,10,1)
x_val = x_val.reshape(x_val.shape[0],x_val.shape[1],1)           # ( ,10,1)
...
# loss :  [3665.269775390625, 49.7801513671875]
# R2 :  -0.22450304238032914