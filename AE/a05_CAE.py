...
from tensorflow.keras.layers import Dense, Input, Conv2D, Flatten, MaxPooling2D, Conv2DTranspose
...
for i, ax in enumerate([ax1, ax2, ax3, ax4, ax5]):
    ax.imshow(x_test_out[random_images[i]].reshape(28, 28), cmap = 'gray')
    if i == 0:
