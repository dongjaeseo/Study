# [실습] keras67_1 남자 여자에 잡음 넣어서 복구
import numpy as np
import random

x_train = np.load('../data/image/gender_generator/train/x_train.npy')
x_test = np.load('../data/image/gender_generator/test/x_test.npy')

# print(x_train.shape) (1389, 256, 256, 3)
# print(x_test.shape) (347, 256, 256, 3)
