...
cp = ModelCheckpoint(monitor = 'val_loss', filepath = '../data/modelcheckpoint/keras62_2_{epoch:2d}_{val_loss:.4f}.hdf5', save_best_only=True)
...
'''
search = load_model('../data/modelcheckpoint/keras62_2_ 8_2346.4805.hdf5')

y_pred = search.predict(x_test)
print('R2 : ', r2_score(y_test, y_pred))

# R2 :  0.3673407129024022