...
for alphabet in alphabets:
    ...
    x1_train = train.loc[train['letter'] == alphabet, '0':]
    x1_train[x1_train<160] = 0
    x1_train = x1_train.to_numpy().reshape(-1,28,28,1)
    y1_train = train.loc[train['letter'] == alphabet, 'digit'].to_numpy()
    x_test = test.loc[test['letter'] == alphabet, '0':]
    x_test[x_test<160] = 0
    ...
    # submission.to_csv('./mnist_1/submission8.csv', index = 0)
