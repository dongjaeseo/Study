...
train2_ens = train2.copy()
train2_ens[train2_ens<192] /= 2

test2 = test.drop(['id','letter'],1)
# test2[test2<40] = 0

test2_ens = test2.copy()
test2_ens[test2_ens<192] /= 2
...
for train_index, valid_index in skf.split(train2,train['digit']) :
    ...
    y_pred = model.predict([test2,test2_ens])
...
sub.to_csv('./mnist_1/submission12.csv', index = 0)
...
# sub.to_csv('./mnist_1/submission12.csv',index=False)